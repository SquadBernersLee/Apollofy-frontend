  ...
  return (
    ...
    <div className="flex flex-col bg-background h-screen">
      ...
      {!filter || filter.length < 3 ? (
        <p className="text-tops text-2xl mt-10 ml-12 lg:ml-80">Search your favourite music!</p>
      ) : (
        <>
          {songs?.length > 0 ? (
            ...
            <div className="text-gray-500 ml-5 mt-3 lg:ml-80">No songs found</div>
          )}
          ...
          {artists?.length > 0 ? (
            ...
            <div className="text-gray-500 ml-5 mt-3 lg:ml-80">No artists found</div>
          )}
          ...
          {albums?.length > 0 ? (
            ...
            <div className="text-gray-500 ml-5 mt-3 lg:ml-80">No albums found</div>
          )}
        </>
      )}
    </div>
